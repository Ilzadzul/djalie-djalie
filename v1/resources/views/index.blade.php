...
<body>
  ...
  <header>
    <div class="header row container">
      <a href="#" class="logo mobile"><img src="{{asset('images/logo.png')}}" alt="Djalie-Djalie"></a>
      ...
      <nav class="navigation row">
        <ul class="row">
          ...
          <li class="desktop"><a href="#"><img src="{{asset('images/logo.png')}}" alt="Djalie-Djalie"></a></li>
    ...
    <div class="row flex container">
      ...
      <div class="swiper services-swiper">
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide"><img src="{{asset('images/photografer.jpg')}}" alt=""></div>
          <div class="swiper-slide"><img src="{{asset('images/music.png')}}" alt=""></div>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      ...
      <div class="a-cards col">
        <div class="a-card team-card">
          <img src="{{asset("images/sq.jpg")}}" alt="">
          <h3>Jane</h3>
          <p>Creative Team</p>
        </div>
        <div class="a-card team-card">
          <img src="{{asset("images/qq.jpg")}}" alt="">
          <h3>Jane</h3>
          <p>Creative Team</p>
        </div>
        <div class="a-card team-card">
          <img src="{{asset("images/bapakamar.jpg")}}" alt="">
          <h3>John</h3>
          <p>Creative Team</p>
        </div>
      </div>
  ...
  <section class="gallery" id="gallery">
    ...
    <div class="container">
      <div class="swiper gallery-swiper">
        <div class="swiper-wrapper">
          <div class="swiper-slide gallery-slide"><img src="{{asset('images/rias1.jpg')}}" alt=""></div>
          <div class="swiper-slide gallery-slide"><img src="{{asset('images/rias2.jpg')}}" alt=""></div>
          <div class="swiper-slide gallery-slide"><img src="{{asset('images/rias3.jpg')}}" alt=""></div>
          <div class="swiper-slide gallery-slide"><img src="{{asset('images/rias4.jpg')}}" alt=""></div>
          <div class="swiper-slide gallery-slide"><img src="{{asset('images/rias5.jpg')}}" alt=""></div>
          <div class="swiper-slide gallery-slide"><img src="{{asset('images/rias6.jpg')}}" alt=""></div>
          <div class="swiper-slide gallery-slide"><img src="{{asset('images/rias7.jpg')}}" alt=""></div>
          <div class="swiper-slide gallery-slide"><img src="{{asset('images/rias8.jpg')}}" alt=""></div>
        </div>
